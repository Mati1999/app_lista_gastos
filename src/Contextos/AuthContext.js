...
const AuthProvider = ({ children }) => {
    ...
    return (
        <AuthContext.Provider value={{ usuario: usuario }}>
            ...
            De esta forma nos aseguramos de no cargar el resto de la app hasta que le usuario haya sido establecido.
            Si no hacemos esto, al refrescar la pagina el componente children intenta cargar inmediatamente, antes de haber comprobado que existe un usuario*/}
            {!cargando && children}
